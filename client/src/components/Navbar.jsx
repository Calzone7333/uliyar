            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex justify-between h-20 items-center">
                    ...
                    <div className="hidden md:flex items-center space-x-10">
                        <button onClick={handlePostJobClick} className="text-white text-[15px] font-medium hover:text-white/80 transition-colors">Post Jobs</button>
            ...
            {isOpen && (
                <div className="md:hidden bg-primary border-t border-white/10 p-4 shadow-xl">
                    <div className="flex flex-col space-y-4">
                        ...
                        <button onClick={() => { setIsOpen(false); handlePostJobClick(); }} className="text-lg font-medium text-white text-left">Post Jobs</button>
