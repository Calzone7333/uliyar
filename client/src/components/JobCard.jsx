                    ...
                    <div className="flex-1 w-full">
                        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-3">
                            ...
                            <div className="flex gap-2 self-start md:self-auto flex-wrap">
                                {job.category && (
                                    <span className="px-3 py-1 rounded-lg text-xs font-bold border bg-purple-50 text-purple-700 border-purple-100">
                                        {job.category}
                                    </span>
                                )}
                                {job.subCategory && (
                                    <span className="px-3 py-1 rounded-lg text-xs font-bold border bg-blue-50 text-blue-700 border-blue-100">
                                        {job.subCategory}
                                    </span>
                                )}
                                <span className={`px-3 py-1 rounded-lg text-xs font-bold border ${getLabelStyle(job.type)}`}>
                                    {job.type}
                                </span>
                            </div>
                        </div>
                        ...
                        <p className="text-gray-500 text-sm leading-relaxed mb-6 line-clamp-2">
                            {job.description || `We are hiring a skilled ${job.title} to join our team at ${job.company}.`}
                        </p>
